...
motor_forces(1) = motor_forces(1) ;
motor_forces(2) = motor_forces(2) ;
motor_forces(3) = motor_forces(3) ;
motor_forces(4) = motor_forces(4) ;
...
% odefun = @(t, var) QuadrotorEOM(t, var, g, m, I, d, km, nu, mu);
...
% PlotAircraftSim(t, y, 0 , [1:6] , 'b-');

y_plot = [y(:,1:3), rad2deg(y(:,7:9)), y(:,4:6), y(:,10:12)]; PlotAircraftSim(t, y_plot, 0 , [1:6] , 'b-');
